...
public class ComputerResponseDTO {
    ...
    public static class Builder {
        ...
        public ComputerResponseDTO build() { return new ComputerResponseDTO(this); }
    }

    private ComputerResponseDTO(Builder builder) {
        this.id = builder.id;
    ...
    public boolean equals(Object o) {
        ...
        ComputerResponseDTO that = (ComputerResponseDTO) o;
